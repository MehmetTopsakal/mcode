...
fnames=['EPSILON_BSERPA_SCRfull_OC11.OUT.xml','EPSILON_BSERPA_SCRfull_OC22.OUT.xml','EPSILON_BSERPA_SCRfull_OC33.OUT.xml']          
...
legends=['EPSILON_BSERPA_SCRfull_OC11','EPSILON_BSERPA_SCRfull_OC22','EPSILON_BSERPA_SCRfull_OC33']
for i in range(nfiles):
...
np.savetxt('epsilons.dat', out, delimiter=",", fmt="%12.4f %16.12f %16.12f %16.12f %16.12f")
