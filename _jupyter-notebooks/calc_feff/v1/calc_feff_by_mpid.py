...
for n,i in enumerate(inputs):
    s=i.split('=')
    if s[0] == 'mpid' or s[0] == 'id' : mpid = s[1]
    if s[0] == 'ca' : ca = s[1]
...
print('\nWelcome to calc_xas_by_mpid')
print('\nrun parameters are:')
print('Materials Project id = '+mpid)
print('Scattering atom symbol = '+ca)
print('FMS radius = '+str(rFMS))
print('SCF radius = '+str(rSCF))
print('core-hole treatment = '+corehole)
print('nmax used to find ineq. ions = '+str(nmax))
print('\n')
...
# This part analyzes structure and finds ineqivalent ions for feff calculation part
...
#This part does feff calculations for inequivalent ions
