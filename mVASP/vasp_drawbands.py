...
vasp_params, kpoints, kpoints_path, klines_path, poscar0, bands_up, bands_dw,     dos_info, efermi, Edos, tdos, pdos_up, pdos_dw = readvasp()
...
for b in range(len(bands_up)):
  ax.plot(kpoints_path,bands_up[b]-efermi+bshift, 'k-', lw=2, mfc='k', ms=3)
  if vasp_params[2] == 2: 
    ax.plot(kpoints_path,bands_dw[b]-efermi+bshift, 'b--', lw=1, mfc='k', ms=0)
