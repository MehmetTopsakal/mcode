function [nspin,E,tdos,pdoss,fermi]=vasp_readpdos2
%
% usage example :
%
...
%   pdoss{s}(:,6)=read(:,3); % s-dw
%   pdoss{s}(:,2)=read(:,4)+read(:,6)+read(:,8); % p-up
%   pdoss{s}(:,7)=read(:,5)+read(:,7)+read(:,9); % p-dw
%   pdoss{s}(:,3)=read(:,10)+read(:,12)+read(:,14)+read(:,16)+read(:,18); % d-up
%   pdoss{s}(:,8)=read(:,11)+read(:,13)+read(:,15)+read(:,17)+read(:,19); % d-dw
%   pdoss{s}(:,4)=read(:,20)+read(:,22)+read(:,24)+read(:,26)+read(:,28)+read(:,30)+read(:,32); % f-up
%   pdoss{s}(:,9)=read(:,21)+read(:,23)+read(:,25)+read(:,27)+read(:,29)+read(:,31)+read(:,33); % f-dw
%  
%   pdoss{s}(:,5)=pdoss{s}(:,1)+pdoss{s}(:,2)+pdoss{s}(:,3)+pdoss{s}(:,4); %sum
%   pdoss{s}(:,10)=pdoss{s}(:,6)+pdoss{s}(:,7)+pdoss{s}(:,8)+pdoss{s}(:,9); %sum
%   end
%  
%   if size(read,2)==19
%   pdoss{s}(:,1)=read(:,2); % s-up
...
%  
%  
%  save pdos.mat nspin E tdos pdoss fermi

load pdos.mat nspin E tdos pdoss fermi
