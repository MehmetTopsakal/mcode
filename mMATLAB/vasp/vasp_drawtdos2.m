function vasp_drawtdos(x1,x2,y1,y2,div)

if nargin < 1,   disp('  ');    disp('USAGE : vasp_drawtdos(x1,x2,y1,y2,div) '); disp('  ');    ; end

if nargin < 5,   div =   8      ; end
...
% nonmagnetic
if  nspin==1
dos = tdos(:,1); de=E(2)-E(1); dos = smooth(E,dos,de/div,'lowess')
...
% magnetic
if  nspin==2
dos_up = tdos(:,1); dos_dw = tdos(:,2); de=E(2)-E(1); dos_up = smooth(E,dos_up,de/div,'lowess') ; dos_dw = smooth(E,dos_dw,de/div,'lowess') ;  
