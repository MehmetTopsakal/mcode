...
class XPDDBlackFlyDetector(SingleTrigger, AreaDetector):
    ...
    tiff = Cpt(XPDDBlackFlyTiffPlugin, 'TIFF1:',
               read_attrs=[],
               configuration_attrs=[],
               write_path_template='/nsls2/data/xpd/tomo/legacy/raw/blackfly_data/%Y/%m/%d/',
               read_path_template='/nsls2/data/xpd/tomo/legacy/raw/blackfly_data/%Y/%m/%d/',
               root='/nsls2/data/xpd/tomo/legacy/raw/blackfly_data/')
