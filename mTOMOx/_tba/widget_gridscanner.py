...
box4 = HBox([w_t1,w_t2,space,button])

ui_gridscanner = VBox([box1,hspace10,box2,box3,hspace10,box4])




def on_button_clicked(b):
    with output_gridscanner:
        clear_output()
        ...
        if w_dd1.value == 'Blackfly':
            ...
            plan = bp.grid_scan([det], 
                                ...
                                w_dd_m2.value , w_frs_m2.value[0] , w_frs_m2.value[1], w_it_m2.value, 
                                False
                               )
            scan_id = RE(plan)     
...
output_gridscanner = widgets.Output();
